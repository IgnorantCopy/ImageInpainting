...
from SuperResolution.train.networks.select_network import define_G
from SuperResolution.train.models.model_base import ModelBase
from SuperResolution.train.models.loss import CharbonnierLoss

from SuperResolution.train.utils.utils_model import test_mode
...
class ModelPlain(ModelBase):
    ...
    def optimize_parameters(self, current_step):
        ...
        with torch.autocast(device_type="cuda", enabled=self.opt['use_amp']):
            self.netG_forward()
            G_loss = self.G_lossfn_weight * self.G_lossfn(self.E, self.H)
        self.amp_scaler.scale(G_loss).backward()

        self.amp_scaler.unscale_(self.G_optimizer)
        # ------------------------------------
        # clip_grad
        # ------------------------------------
