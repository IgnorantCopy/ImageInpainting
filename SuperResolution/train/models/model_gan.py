...
from SuperResolution.train.networks.select_network import define_G, define_D
from SuperResolution.train.models.model_base import ModelBase
from SuperResolution.train.models.loss import GANLoss, PerceptualLoss
...
class ModelGAN(ModelBase):
    ...
    def optimize_parameters(self, current_step):
        ...
        if current_step % self.D_update_ratio == 0 and current_step > self.D_init_iters:  # updata D first
            ...
            self.amp_scaler.scale(loss_G_total).backward()
        ...
        self.amp_scaler.step(self.D_optimizer)
        self.amp_scaler.update()
