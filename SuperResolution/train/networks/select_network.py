...
def define_G(opt):
    ...
    if net_type == 'msrresnet':
        from ImageInpainting.SuperResolution.train.networks.network_srresnet import MSRResNet as net
...
def define_D(opt):
    ...
    if net_type == 'discriminator_unet':
        from ImageInpainting.SuperResolution.train.networks.network_discriminator import Discriminator_UNet as discriminator
...
def define_F(opt, use_bn=False):
    ...
    from network_feature import VGGFeatureExtractor
